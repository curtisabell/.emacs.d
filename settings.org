...
(defun my-LaTeX-mode-hook ()
  ...
  (local-set-key (kbd "C-c M-|") 'abell/TeX-pipe-brackets)
  (local-set-key (kbd "C-c M-<") 'abell/TeX-angular-brackets)
...
**** Insert inline-math
#+begin_src emacs-lisp
;; ;; Inline using LaTeX notation
;; (defun TeX-inline-math-abell()
;;   (interactive)
;;   (insert "\\(  \\)")
;;   (backward-char 3))

;; Inline using TeX notation
(defun TeX-inline-math-abell()
  (interactive)
  (insert "$$")
  (backward-char 1))
...
#+begin_src emacs-lisp
  ...
  (defun abell/TeX-pipe-brackets ()
    (interactive)
    (insert "\\left|  \\right|")
    (backward-char 8)
    )

  (defun abell/TeX-angular-brackets ()
    (interactive)
    (insert "\\left<  \\right>")
    (backward-char 8)
    )
...
*** Code marking
#+begin_src emacs-lisp
(global-set-key (kbd "C-c n") (lambda () (interactive) (insert-char 10007))) ; ✗
(global-set-key (kbd "C-c y") (lambda () (interactive) (insert-char 10003))) ; ✓
