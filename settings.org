...
(use-package electric-operator
  :ensure t
  :hook
  ((f90-mode python-mode latex-mode) . electric-operator-mode)
  :config
  ...
  (defun electric-operator-f90-mode-/()
    ...
    "Don't love the looking back locally check, but unsure how to improve"
    (cond
     ((electric-operator-just-inside-bracket) "/ ")
...
* TOOD
** TODO Figure out good keybinding for popper mode
** TODO Investigate shackle.el
